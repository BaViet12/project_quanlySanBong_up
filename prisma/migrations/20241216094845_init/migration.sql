/*
  ...
  - You are about to drop the column `timeslot_id` on the `booking` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE `booking` DROP FOREIGN KEY `Booking_timeslot_id_fkey`;

-- AlterTable
ALTER TABLE `booking` DROP COLUMN `timeslot_id`,
