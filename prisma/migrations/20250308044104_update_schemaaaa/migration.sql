/*
  ...
  - Added the required column `cart_id` to the `Booking` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `booking` ADD COLUMN `cart_id` INTEGER NOT NULL,
